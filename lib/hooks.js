...
Router.onBeforeAction(filters.isAdmin, {only: ['dashboard', 'showUser', 'editUserRoles', 'listProducts', 'showProduct', 'editUser', 'newProduct', 'editProduct', 'allOrders', 'showAdminOrder']});
